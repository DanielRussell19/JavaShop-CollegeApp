...
public class FrmMainMenu extends javax.swing.JFrame {
    ...
    //navigates to customer login form
    private void btnCustomerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCustomerActionPerformed
        //Sends to Customer Login form
        FrmCustomerLogin newFrm = new FrmCustomerLogin();
        this.dispose();
        newFrm.setVisible(true);
    }//GEN-LAST:event_btnCustomerActionPerformed

    //navigates to staff login form
    private void btnStaffActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnStaffActionPerformed
        //Sends to Staff login form
        FrmStaffLogin newFrm = new FrmStaffLogin();
        this.dispose();
        newFrm.setVisible(true);
    ...
    private void btnQuitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnQuitActionPerformed
        //ends program with build successfull
        System.exit(0);
    }//GEN-LAST:event_btnQuitActionPerformed

    //navigates to view product form as non registered user
    private void btnViewProductActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewProductActionPerformed
        FrmCustomerViewProduct newFrm = new FrmCustomerViewProduct(new Customer());
        newFrm.setVisible(true);
        this.dispose();
